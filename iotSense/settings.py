"""
Django settings for iotSense project.
...
SECRET_KEY = 'p2m@z8hsjullzax$muc*effyp*mz%f2lqpy29j#dnjmd+ew&f1'
...
WSGI_APPLICATION = 'iotSense.wsgi.application'
